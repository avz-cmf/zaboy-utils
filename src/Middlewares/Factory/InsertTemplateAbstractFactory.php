...
/**
 * Factory for middleware which Insert Template
 * 
 * config
 * <code>
 *  'middleware' => [
 *      'MiddlewareName' => [
 *          'class' => 'zaboy\utils\InsertTemplate',
 *          //write to response this template
 *          'templateBefore' =>'path\to\TemplateBefore', 
 *          //call next(...
 *          //write to response this template
 *          'templateAfter' => 'path\to\TemplateAfter'
 *      ], ...
 *  ], 
 * </code>
 * @category   DataStores
 * @package    DataStores
 */
class InsertTemplateAbstractFactory  implements AbstractFactoryInterface
{
    /**
    ...
    public function canCreate(ContainerInterface $container, $requestedName) 
    {
        ...
        if ($isClassName) {
            ...
            return is_a($requestedClassName, 'zaboy\utils\Middlewares\InsertTemplate', true);
        }else{
            return false;
        }
    }
    ...
    public function __invoke(ContainerInterface $container, $requestedName, array $options = null) 
    {
        ...
        $templateBefore = isset($serviceConfig['templateBefore']) ? $serviceConfig['templateBefore'] : null;
        $templateAfter = isset($serviceConfig['templateAfter']) ? $serviceConfig['templateAfter'] : null;
